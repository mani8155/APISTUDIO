...
Revision ID: 637d69cdf292
Revises: 5c0927c63414
Create Date: 2024-03-02 12:52:06.700786
...
revision: str = '637d69cdf292'
down_revision: Union[str, None] = '5c0927c63414'
...
def upgrade() -> None:
    ...
    sa.Column('ord_no', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_asa0202_01_01_psk_id'), 'asa0202_01_01', ['psk_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_asa0202_01_01_psk_id'), table_name='asa0202_01_01')
    op.drop_table('asa0202_01_01')
    # ### end Alembic commands ###
