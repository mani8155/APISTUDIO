...
Revision ID: da611a293b18
Revises: a86473429890
Create Date: 2024-03-02 12:58:06.434718
...
revision: str = 'da611a293b18'
down_revision: Union[str, None] = 'a86473429890'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_asa0205_01_01_psk_id'), 'asa0205_01_01', ['psk_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_asa0205_01_01_psk_id'), table_name='asa0205_01_01')
    op.drop_table('asa0205_01_01')
    # ### end Alembic commands ###
