...
Revision ID: 5c0927c63414
Revises: 28396f001c07
Create Date: 2024-03-02 12:24:33.160498
...
revision: str = '5c0927c63414'
down_revision: Union[str, None] = '28396f001c07'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_asa0201_01_01_psk_id'), 'asa0201_01_01', ['psk_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_asa0201_01_01_psk_id'), table_name='asa0201_01_01')
    op.drop_table('asa0201_01_01')
    # ### end Alembic commands ###
